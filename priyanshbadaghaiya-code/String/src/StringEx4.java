public class StringEx4 {
	public static void main(String[] args) {
		...
		System.out.println(s1.indexOf("Lalla"));
		System.out.println("  ram          kumar  ".trim());
		System.out.println(s1.equals(s2));
		System.out.println(s1.equals("Priyansh Badaghaiya"));
		System.out.println(s1.equals("Priyansh Badaghaiya"));
		System.out.println(s1.equalsIgnoreCase("Priyansh Badaghaiya"));
